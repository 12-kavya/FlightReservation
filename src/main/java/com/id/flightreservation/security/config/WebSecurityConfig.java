...
//	AuthenticationManagerBuilder auth;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests()
				.requestMatchers(WEB_URL+"login/registerUser.jsp",WEB_URL+"login/login.jsp",WEB_URL+"completeReservation.jsp",WEB_URL+"displayFlight.jsp",WEB_URL+"findFlights.jsp",WEB_URL+"login/reservationConfirmation."
						+ ".jsp", "/showReg", "/", "/index.html", "/registerUser", "/login",
